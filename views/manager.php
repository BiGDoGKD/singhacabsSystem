...
<body>
            ...
            <div class="side-menu">
                <div id="mySidenav" class="sidenav">
                    ...
                    <div class="profile-card">
                        ...
                        <span class="username"><?php echo $_SESSION["M"]; ?></span><br />
                    ...
                    <a href="#" onclick="reportView1()">Home</a>
                    <a href="#" onclick="settingsView()">Account Settings</a>
                </div>
            </div>
            <div id="report-view1" style="display: block;">
                <?php include './manager_views/report1.php' ?>
            </div>

            <div id="settings-view" style="display: none;">
                <?php include './manager_views/editmanager.php' ?>
            </div>
        </div>
        <div class="footer">
            <div id="footer">
    ...
    <script>
        ...
        function reportView1() {
            document.getElementById("report-view1").style.display = "block";
            document.getElementById("settings-view").style.display = "none";
        }

        function settingsView() {
            document.getElementById("report-view1").style.display = "none";
